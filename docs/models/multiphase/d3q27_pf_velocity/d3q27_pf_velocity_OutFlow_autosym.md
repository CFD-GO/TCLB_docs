...
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(HEAD detached at 67a6be7)/src/d3q27_pf_velocity_OutFlow_autosym/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(HEAD detached at 67a6be7)/src/d3q27_pf_velocity_OutFlow_autosym/Dynamics.R)
...
|BOUNDARY|EPressure, WPressure, NVelocity, EVelocity, WVelocity, MovingWall_N, MovingWall_S, Solid, Wall, ENeumann, EConvect|
|COLLISION|BGK, MRT|
