...
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(HEAD detached at cbad57a)/src/d3q19_kuper/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(HEAD detached at cbad57a)/src/d3q19_kuper/Dynamics.R)
...
| Group | Types |
| --- | --- |
|BOUNDARY|EPressure, Solid, Wall, WPressure, WPressureL, WVelocity, MovingWall|
|COLLISION|MRT|
