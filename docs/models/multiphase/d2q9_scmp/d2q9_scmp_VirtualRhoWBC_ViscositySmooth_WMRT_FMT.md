...
## Description
d2q9_scmp_VirtualRhoWBC_ViscositySmooth_WMRT_FMT


## Details
[Model description files](Model description) files for this model:
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(HEAD detached at cbad57a)/src/d2q9_scmp_VirtualRhoWBC_ViscositySmooth_WMRT_FMT/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(HEAD detached at cbad57a)/src/d2q9_scmp_VirtualRhoWBC_ViscositySmooth_WMRT_FMT/Dynamics.R)
