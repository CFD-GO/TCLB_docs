...
## Description
d2q9_scmp_Kupershtokh_VirtualRhoWBC_ViscositySmooth_WMRT_FMT_HiOrd


## Details
[Model description files](Model description) files for this model:
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(HEAD detached at 67a6be7)/src/d2q9_scmp_Kupershtokh_VirtualRhoWBC_ViscositySmooth_WMRT_FMT_HiOrd/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(HEAD detached at 67a6be7)/src/d2q9_scmp_Kupershtokh_VirtualRhoWBC_ViscositySmooth_WMRT_FMT_HiOrd/Dynamics.R)
