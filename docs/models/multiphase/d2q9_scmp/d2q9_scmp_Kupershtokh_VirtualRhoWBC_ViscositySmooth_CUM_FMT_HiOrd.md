...
## Description
d2q9_scmp_Kupershtokh_VirtualRhoWBC_ViscositySmooth_CUM_FMT_HiOrd


## Details
[Model description files](Model description) files for this model:
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(HEAD detached at fba1799)/src/d2q9_scmp_Kupershtokh_VirtualRhoWBC_ViscositySmooth_CUM_FMT_HiOrd/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(HEAD detached at fba1799)/src/d2q9_scmp_Kupershtokh_VirtualRhoWBC_ViscositySmooth_CUM_FMT_HiOrd/Dynamics.R)
