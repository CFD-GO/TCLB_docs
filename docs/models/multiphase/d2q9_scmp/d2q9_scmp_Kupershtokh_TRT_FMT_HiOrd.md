...
## Description
d2q9_scmp_Kupershtokh_TRT_FMT_HiOrd


## Details
[Model description files](Model description) files for this model:
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(HEAD detached at cbad57a)/src/d2q9_scmp_Kupershtokh_TRT_FMT_HiOrd/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(HEAD detached at cbad57a)/src/d2q9_scmp_Kupershtokh_TRT_FMT_HiOrd/Dynamics.R)
