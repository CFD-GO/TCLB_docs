...
## Description
d2q9_scmp_ViscositySmooth_WMRT


## Details
[Model description files](Model description) files for this model:
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(HEAD detached at 9e1ceb1)/src/d2q9_scmp_ViscositySmooth_WMRT/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(HEAD detached at 9e1ceb1)/src/d2q9_scmp_ViscositySmooth_WMRT/Dynamics.R)
