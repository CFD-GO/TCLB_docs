...
## Description
d3q27_PSM_TRT_SEP_singlekernel


## Details
[Model description files](Model description) files for this model:
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(HEAD detached at cbad57a)/src/d3q27_PSM_TRT_SEP_singlekernel/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(HEAD detached at cbad57a)/src/d3q27_PSM_TRT_SEP_singlekernel/Dynamics.R)
